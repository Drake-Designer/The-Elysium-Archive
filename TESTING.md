...
### Python Validation (CI Python Linter - PEP8CI)

All key Python files were validated using the Code Institute Python Linter (PEP8CI). All files show "All clear, no errors found".

| File | Validation Link | Screenshot | Result |
| --- | --- | --- | --- |
| `accounts/admin.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/accounts/admin.py) | ![accounts/admin.py](documentation/testing/python-validation/accounts-admin.png) | All clear, no errors found |
| `accounts/apps.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/accounts/apps.py) | ![accounts/apps.py](documentation/testing/python-validation/account-apps.png) | All clear, no errors found |
| `accounts/backends.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/accounts/backends.py) | ![accounts/backends.py](documentation/testing/python-validation/accounts-backends.png) | All clear, no errors found |
| `accounts/decorators.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/accounts/decorators.py) | ![accounts/decorators.py](documentation/testing/python-validation/accounts-decorators.png) | All clear, no errors found |
| `accounts/forms.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/accounts/forms.py) | ![accounts/forms.py](documentation/testing/python-validation/accounts-forms.png) | All clear, no errors found |
| `accounts/models.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/accounts/models.py) | ![accounts/models.py](documentation/testing/python-validation/accounts-models.png) | All clear, no errors found |
| `accounts/signals.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/accounts/signals.py) | ![accounts/signals.py](documentation/testing/python-validation/accounts-signals.png) | All clear, no errors found |
| `accounts/urls.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/accounts/urls.py) | ![accounts/urls.py](documentation/testing/python-validation/accounts-urls.png) | All clear, no errors found |
| `accounts/views.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/accounts/views.py) | ![accounts/views.py](documentation/testing/python-validation/accounts-views.png) | All clear, no errors found |
| `cart/apps.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/cart/apps.py) | ![cart/apps.py](documentation/testing/python-validation/cart-apps.png) | All clear, no errors found |
| `cart/cart.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/cart/cart.py) | ![cart/cart.py](documentation/testing/python-validation/cart-cart.png) | All clear, no errors found |
| `cart/models.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/cart/models.py) | ![cart/models.py](documentation/testing/python-validation/cart-models.png) | All clear, no errors found |
| `cart/signals.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/cart/signals.py) | ![cart/signals.py](documentation/testing/python-validation/cart-signals.png) | All clear, no errors found |
| `cart/urls.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/cart/urls.py) | ![cart/urls.py](documentation/testing/python-validation/cart-urls.png) | All clear, no errors found |
| `cart/views.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/cart/views.py) | ![cart/views.py](documentation/testing/python-validation/cart-views.png) | All clear, no errors found |
| `checkout/urls.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/checkout/urls.py) | ![checkout/urls.py](documentation/testing/python-validation/checkout-urls.png) | All clear, no errors found |
| `checkout/views.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/checkout/views.py) | ![checkout/views.py](documentation/testing/python-validation/checkout-views.png) | All clear, no errors found |
| `checkout/webhooks.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/checkout/webhooks.py) | ![checkout/webhooks.py](documentation/testing/python-validation/checkout-webhooks.png) | All clear, no errors found |
| `elysium_archive/context_processors.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/elysium_archive/context_processors.py) | ![elysium_archive/context_processors.py](documentation/testing/python-validation/elysium_archive-context_processors.png) | All clear, no errors found |
| `elysium_archive/helpers.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/elysium_archive/helpers.py) | ![elysium_archive/helpers.py](documentation/testing/python-validation/elysium_archive-helpers.png) | All clear, no errors found |
| `elysium_archive/settings.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/elysium_archive/settings.py) | ![elysium_archive/settings.py](documentation/testing/python-validation/elysium_archive-settings.png) | All clear, no errors found |
| `elysium_archive/settings_test.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/elysium_archive/settings_test.py) | ![elysium_archive/settings_test.py](documentation/testing/python-validation/elysium_archive-settings_test.png) | All clear, no errors found |
| `elysium_archive/type_guards.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/elysium_archive/type_guards.py) | ![elysium_archive/type_guards.py](documentation/testing/python-validation/elysium_archive-type_guards.py.png) | All clear, no errors found |
| `elysium_archive/urls.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/elysium_archive/urls.py) | ![elysium_archive/urls.py](documentation/testing/python-validation/elysium_archive-urls.png) | All clear, no errors found |
| `elysium_archive/wsgi.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/elysium_archive/wsgi.py) | ![elysium_archive/wsgi.py](documentation/testing/python-validation/elysium_archive-wsgi.png) | All clear, no errors found |
| `home/forms.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/home/forms.py) | ![home/forms.py](documentation/testing/python-validation/home-forms.png) | All clear, no errors found |
| `home/urls.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/home/urls.py) | ![home/urls.py](documentation/testing/python-validation/home-urls.png) | All clear, no errors found |
| `home/views.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/home/views.py) | ![home/views.py](documentation/testing/python-validation/home-views.png) | All clear, no errors found |
| `orders/admin.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/orders/admin.py) | ![orders/admin.py](documentation/testing/python-validation/orders-admin.png) | All clear, no errors found |
| `orders/models.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/orders/models.py) | ![orders/models.py](documentation/testing/python-validation/orders-models.png) | All clear, no errors found |
| `orders/order_utils.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/orders/order_utils.py) | ![orders/order_utils.py](documentation/testing/python-validation/orders-order_utils.png) | All clear, no errors found |
| `orders/services.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/orders/services.py) | ![orders/services.py](documentation/testing/python-validation/orders-services.png) | All clear, no errors found |
| `products/admin.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/products/admin.py) | ![products/admin.py](documentation/testing/python-validation/products-admin.png) | All clear, no errors found |
| `products/admin_utils.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/products/admin_utils.py) | ![products/admin_utils.py](documentation/testing/python-validation/products-admin_utils.png) | All clear, no errors found |
| `products/models.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/products/models.py) | ![products/models.py](documentation/testing/python-validation/products-models.png) | All clear, no errors found |
| `products/urls.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/products/urls.py) | ![products/urls.py](documentation/testing/python-validation/products-urls.png) | All clear, no errors found |
| `products/views.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/products/views.py) | ![products/views.py](documentation/testing/python-validation/products-views.png) | All clear, no errors found |
| `reviews/admin.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/reviews/admin.py) | ![reviews/admin.py](documentation/testing/python-validation/reviews-admin.png) | All clear, no errors found |
| `reviews/forms.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/reviews/forms.py) | ![reviews/forms.py](documentation/testing/python-validation/reviews-forms.png) | All clear, no errors found |
| `reviews/models.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/reviews/models.py) | ![reviews/models.py](documentation/testing/python-validation/reviews-models.png) | All clear, no errors found |
| `reviews/views.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/reviews/views.py) | ![reviews/views.py](documentation/testing/python-validation/reviews-views.png) | All clear, no errors found |
| `conftest.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/conftest.py) | ![conftest.py](documentation/testing/python-validation/main-conftest.png) | All clear, no errors found |
| `manage.py` | [CI Python Linter](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Drake-Designer/The-Elysium-Archive/refs/heads/main/manage.py) | ![manage.py](documentation/testing/python-validation/main-manage.png) | All clear, no errors found |
