...
class TestArchiveReadAccess:
    ...
    def test_anonymous_user_redirected_to_login(self, client, product_active):
        ...
        response = client.get(
            reverse("archive_read", args=[product_active.slug])
        )
    ...
    def test_owner_can_access_reading_page(
        self, client, verified_user, product_active
    ):
    ...
    def test_reading_page_displays_full_content(
        ...
        assert (
            product_active.content in content
            or "Complete Archive Entry" in content
        )
    ...
    def test_unverified_email_redirected_to_verification(
        ...
        AccessEntitlement.objects.create(
            user=unverified_user, product=product_active
        )
...
class TestPreviewPageContentSeparation:
    ...
    def test_preview_page_does_not_show_full_content_for_owner(
        ...
        assert (
            "archive_read" in content
            or f"{product_active.slug}/read/" in content
        )
    ...
    def test_anonymous_preview_does_not_show_full_content(
...
class TestReadingPageNavigation:
    ...
    def test_reading_page_has_back_to_my_archive(
        ...
        assert (
            "/accounts/archive/" in content or "my_archive" in content.lower()
        )
